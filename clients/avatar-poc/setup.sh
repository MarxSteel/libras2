...
mkdir -p "$VENDOR/build" "$VENDOR/examples/jsm/controls" "$VENDOR/examples/jsm/loaders" "$VENDOR/examples/jsm/utils" "$BVH" "$GLB"
...
echo "  - selecione o avatar, cole uma frase, clique Tokenizar, depois Tocar"
